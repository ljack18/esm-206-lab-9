...
summary(homes_lm1) #<- terrible model
...
# Overall, heterodcedasticity is OK, residuals normality definately looks good, and conceptually and mathmatically my model is making sense!
```
...
#never select a final model based strictly on the AIC

# Answer: which would you pick? 
#I would still pick homes_lm3 , even thought it has a higher AIC number, because: # Overall, heterodcedasticity is OK, residuals normality definately looks good, and conceptually and mathmatically my model is making sense!
```
